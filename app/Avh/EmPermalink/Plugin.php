...
class Plugin
{
    ...
    private function registerPostTypeEvent()
    {
        $event_post_type = [
            ...
            'supports'            => apply_filters('em_cp_event_supports',
                                                   [
                                                       'custom-fields',
                                                       'title',
                                                       'editor',
    ...
    private function registerPostTypeEventRecurring()
    {
        if (get_option('dbem_recurrence_enabled')) {
            $event_recurring_post_type = [
                ...
                'publicly_queryable'  => apply_filters('em_cp_event_recurring_publicly_queryable',
                                                       false),
                ...
                'labels'              => [
                    ...
                    'add_new'            => __('Add Recurring Event',
                                               'dbem'),
                    'add_new_item'       => __('Add New Recurring Event',
                                               'dbem'),
                    'edit'               => __('Edit', 'dbem'),
                    'edit_item'          => __('Edit Recurring Event',
                                               'dbem'),
                    'new_item'           => __('New Recurring Event',
                                               'dbem'),
                    'view'               => __('View', 'dbem'),
                    'view_item'          => __('Add Recurring Event',
                                               'dbem'),
                    'search_items'       => __('Search Recurring Events',
                                               'dbem'),
                    'not_found'          => __('No Recurring Events Found',
                                               'dbem'),
                    'not_found_in_trash' => __('No Recurring Events Found in Trash',
                                               'dbem'),
                    'parent'             => __('Parent Recurring Event',
                                               'dbem')
                ]
            ];
    ...
    private function registerPostTypeLocation()
    {
        if (get_option('dbem_locations_enabled', true)) {
            $location_post_type = [
                ...
                'hierarchical'        => false,
                'show_in_admin_bar'   => true,
                'show_ui'             => !(EM_MS_GLOBAL &&
                                           !is_main_site() &&
                                           get_site_option('dbem_ms_mainblog_locations')),
                'show_in_menu'        => 'edit.php?post_type=' . EM_POST_TYPE_EVENT,
                'show_in_nav_menus'   => true,
                'can_export'          => true,
                ...
                'supports'            => apply_filters('em_cp_location_supports',
                                                       [
                                                           'title',
                                                           'editor',
                                                           'excerpt',
    ...
    private function registerTaxonomyEventCategory()
    {
        if (get_option('dbem_categories_enabled', true)) {
            ...
            register_taxonomy(EM_TAXONOMY_CATEGORY,
                              $supported_array,
                              [
                                  'hierarchical'   => true,
                                  'public'         => true,
                                  ...
                                  'labels'         => [
                                      ...
                                      'seperate_items_with_commas' => __('Seperate event categories with commas',
                                                                         'dbem'),
                                      'add_or_remove_items'        => __('Add or remove events', 'dbem'),
                                      'choose_from_the_most_used'  => __('Choose from most used event categories',
                                                                         'dbem')
                                  ],
                                  'capabilities'   => [
    ...
    private function registerTaxonomyEventTag()
    {
        if (get_option('dbem_tags_enabled', true)) {
            register_taxonomy(EM_TAXONOMY_TAG,
                              ...
                              [
                                  ...
                                  'labels'         => [
                                      ...
                                      'seperate_items_with_commas' => __('Seperate event tags with commas',
                                                                         'dbem'),
                                      'add_or_remove_items'        => __('Add or remove events', 'dbem'),
                                      'choose_from_the_most_used'  => __('Choose from most used event tags',
                                                                         'dbem')
                                  ],
                                  'capabilities'   => [
                                      'manage_terms' => 'edit_event_categories',
