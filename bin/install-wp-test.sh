...
install_wp() {
	...
	if [ $WP_VERSION == 'latest' ]; then
		local ARCHIVE_NAME="master.tar.gz"
	else
		local ARCHIVE_NAME="${WP_VERSION}.tar.gz"
	fi

	wget -nv -O /tmp/wordpress.tar.gz https://github.com/WordPress/WordPress/archive/${ARCHIVE_NAME}
